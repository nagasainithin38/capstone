...
@Component({
  selector: 'app-pending-ven',
  templateUrl: './pending-ven.component.html',
  styleUrls: ['./pending-ven.component.css']
})
export class PendingVenComponent {
  isLoading:boolean=true
  pendingVendors:Array<UserVendorDto>=[]
  constructor(private http:HttpService,private toast:ToastrService){

    this.http.getPending("vendor","pending").subscribe(
      (data)=>{
